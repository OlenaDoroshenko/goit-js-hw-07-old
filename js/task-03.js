...
const addItemList = (array) => array.map(image=>{
    const item = `<li><img src=${image.url} alt=${image.alt} width=400px"></li>`
    return item;
});

gallery.insertAdjacentHTML('afterbegin', addItemList(images));
